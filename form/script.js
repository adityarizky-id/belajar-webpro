class PageChanger {
  ...
  const photos = {
    bombardier : {
                    ...
                    imageUrl: 'https://practicum-content.s3.us-west-1.amazonaws.com/html-forms/moved_BOMBARDIER.jpg',
                    photoYear: '2017',
                    creditLink: 'https://www.flickr.com/photos/sloppyperfectionist/',
                    ccLink: 'https://creativecommons.org/licenses/by/2.0/legalcode',
                    ccType: 'CC BY-SA 2.0',
                    ccImg: 'https://practicum-content.s3.us-west-1.amazonaws.com/html-forms/moved_BOMBARDIER_CC.svg',
                    ccHeight: '10px',
                  },
    hobbit : {
                photoName: 'Smaug!',
                photoAuthor: 'Alan Wilson',
                imageUrl: 'https://practicum-content.s3.us-west-1.amazonaws.com/html-forms/moved_HOBBIT.jpg',
                photoYear: '2014',
                creditLink: 'https://www.flickr.com/photos/ajw1970/14323036295/',
                ccLink: 'https://creativecommons.org/licenses/by/2.0/legalcode',
                ccType: 'CC BY-SA 2.0',
                ccImg: 'https://practicum-content.s3.us-west-1.amazonaws.com/html-forms/moved_HOBBIT_CC.svg',
                ccHeight: '10px'
              },
    tiger : {
                photoName: 'EI-XLD',
                photoAuthor: 'Papas Dos',
                imageUrl: 'https://practicum-content.s3.us-west-1.amazonaws.com/html-forms/moved_TIGER.jpg',
                creditLink: 'https://www.flickr.com/photos/papasdos/34150356073/',
                photoYear: '2017',
                ccLink: 'https://creativecommons.org/licenses/by/2.0/legalcode',
                ccType: 'CC BY 2.0',
                ccImg: 'https://practicum-content.s3.us-west-1.amazonaws.com/html-forms/moved_TIGER_CC.svg',
                ccHeight: '18px',
              },
    connected : {
                  photoName: 'N709JB Fly-Fi',
                  photoAuthor: 'Dave Montiverdi',
                  imageUrl: 'https://practicum-content.s3.us-west-1.amazonaws.com/html-forms/moved_CONNECTED.jpg',
                  photoYear: '2018',
                  ...
                  ccImg: 'https://practicum-content.s3.us-west-1.amazonaws.com/html-forms/moved_CONNECTED_CC.svg',
                  ccHeight: '10px',
                },
  }
  ...
  document.querySelector('.form__admin').addEventListener('submit', function(e) {
    ...
    switch(page.getValue('image')) {
      ...
      case 'hobbit':
          ...
          captionToChange.innerHTML = 'Dragon just landed in Los Angeles. ' + createCredit(photos.hobbit);
          break;
      case 'tiger':
          imgOnPageToChange.setAttribute('src', photos.tiger.imageUrl);
          imgOnPageToChange.setAttribute('alt', photos.tiger.photoName);
          captionToChange.innerHTML = 'Amur Tiger Boeing 747 over the Vnukovo international airport. ' + createCredit(photos.tiger);
          break;
      case 'connected':
          ...
          captionToChange.innerHTML = 'At the Westchester, NY airport. ' + createCredit(photos.connected);
          break;
      default:
          imgOnPageToChange.setAttribute('src', photos.bombardier.imageUrl);
          imgOnPageToChange.setAttribute('alt', photos.bombardier.photoName);
